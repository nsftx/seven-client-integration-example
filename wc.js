(function () {
  class KenoTicketDetials extends HTMLElement {
    constructor() {
  ...
  customElements.define('seven-widget-keno-ticket-details', KenoTicketDetials);
